            ...
            child: ListView(
              ...
              children: [
                ...
                _ToolChip(
                  ...
                  onTap: () => context.push('/fitness/progress-photos'),
                ),
                const SizedBox(width: 8),
                _ToolChip(
                  icon: Icons.medication_outlined,
                  label: 'Supplements',
                  onTap: () => context.push('/fitness/supplements'),
                ),
                const SizedBox(width: 8),
                _ToolChip(
                  icon: Icons.directions_run_rounded,
                  label: 'Cardio',
                  onTap: () => context.push('/fitness/cardio'),
                ),
                const SizedBox(width: 8),
                _ToolChip(
                  icon: Icons.bedtime_outlined,
                  label: 'Recovery',
                  onTap: () => context.push('/fitness/recovery'),
                ),
                const SizedBox(width: 8),
                _ToolChip(
                  icon: Icons.show_chart_rounded,
                  label: 'Strength Progress',
                  onTap: () => context.push('/fitness/strength-progress'),
                ),
              ],
            ),
          ),
